...
const account_module_1 = __webpack_require__(29);
const tinhluong_module_1 = __webpack_require__(33);
...
const common_1 = __webpack_require__(6);
const mongoose_1 = __webpack_require__(9);
const account_controller_1 = __webpack_require__(30);
const account_service_1 = __webpack_require__(31);
const account_schema_1 = __webpack_require__(32);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TinhluongModule = void 0;
const common_1 = __webpack_require__(6);
const mongoose_1 = __webpack_require__(9);
const tinhluong_controller_1 = __webpack_require__(34);
const tinhluong_service_1 = __webpack_require__(35);
const tinhluong_schema_1 = __webpack_require__(36);
let TinhluongModule = class TinhluongModule {
};
exports.TinhluongModule = TinhluongModule;
exports.TinhluongModule = TinhluongModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: tinhluong_schema_1.Tinhluong.name, schema: tinhluong_schema_1.TinhluongSchema }]),
        ],
        controllers: [tinhluong_controller_1.TinhluongController],
        providers: [tinhluong_service_1.TinhluongService],
    })
], TinhluongModule);
...
var _a, _b, _c;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TinhluongController = void 0;
const common_1 = __webpack_require__(6);
const tinhluong_service_1 = __webpack_require__(35);
let TinhluongController = class TinhluongController {
    constructor(tinhluongService) {
...
exports.TinhluongController = TinhluongController;
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], TinhluongController.prototype, "getAllTinhluong", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TinhluongController.prototype, "getTinhluongById", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof Partial !== "undefined" && Partial) === "function" ? _b : Object]),
    __metadata("design:returntype", Promise)
], TinhluongController.prototype, "createTinhluong", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    ...
    __metadata("design:paramtypes", [String, typeof (_c = typeof Partial !== "undefined" && Partial) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
], TinhluongController.prototype, "updateTinhluong", null);
__decorate([
    (0, common_1.Delete)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TinhluongController.prototype, "deleteTinhluong", null);
exports.TinhluongController = TinhluongController = __decorate([
    (0, common_1.Controller)('tinhluong'),
    __metadata("design:paramtypes", [typeof (_a = typeof tinhluong_service_1.TinhluongService !== "undefined" && tinhluong_service_1.TinhluongService) === "function" ? _a : Object])
], TinhluongController);
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TinhluongSchema = exports.Tinhluong = void 0;
const mongoose_1 = __webpack_require__(9);
const mongoose_2 = __webpack_require__(12);
const Nhansu_schema_1 = __webpack_require__(14);
let Tinhluong = class Tinhluong extends mongoose_2.Document {
};
exports.Tinhluong = Tinhluong;
__decorate([
    (0, mongoose_1.Prop)({ type: 'ObjectId', ref: 'Idns' }),
    __metadata("design:type", typeof (_a = typeof Nhansu_schema_1.NhanSu !== "undefined" && Nhansu_schema_1.NhanSu) === "function" ? _a : Object)
], Tinhluong.prototype, "Idns", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Tinhluong.prototype, "Ngay", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Tinhluong.prototype, "Thang", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Tinhluong.prototype, "Nam", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Tinhluong.prototype, "luong", void 0);
exports.Tinhluong = Tinhluong = __decorate([
    (0, mongoose_1.Schema)()
], Tinhluong);
exports.TinhluongSchema = mongoose_1.SchemaFactory.createForClass(Tinhluong);
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("4fdc486b3360fd9d9412")
/******/ 	})();
/******/ 	
